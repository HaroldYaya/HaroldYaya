...
Hola 👋, soy **Harold Yaya**, estudiante de **Análisis de Sistemas Empresariales** y desarrollador en formación.

Me interesa el desarrollo de software, especialmente la creación de aplicaciones web, APIs y soluciones que permitan resolver problemas de manera práctica.

Actualmente estoy fortaleciendo mis conocimientos en programación, bases de datos, desarrollo backend, control de versiones, contenedores y servicios en la nube.
